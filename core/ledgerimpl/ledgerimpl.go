...
func (l *LedgerImpl) SetResourceLimits(index common.AccountName, self bool, cpu, net float32) error {
	return l.ChainTx.StateDB.SetResourceLimits(index, self, cpu, net)
}
