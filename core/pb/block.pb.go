...
func (m *TransactionPayload) GetFrom() []byte {
	if m != nil {
		return m.From
	}
	return nil
...
func (m *TransactionPayload) GetAddr() []byte {
	if m != nil {
		return m.Addr
	}
	return nil
...
func (*StateObject) Descriptor() ([]byte, []int) { return fileDescriptorBlock, []int{13} }
...
func (*Account) Descriptor() ([]byte, []int) { return fileDescriptorBlock, []int{14} }
...
func (*Contract) Descriptor() ([]byte, []int) { return fileDescriptorBlock, []int{15} }
...
func (*BlockCt) Descriptor() ([]byte, []int) { return fileDescriptorBlock, []int{16} }
...
func (*PullBlocksRequest) Descriptor() ([]byte, []int) { return fileDescriptorBlock, []int{17} }
...
func (*PullBlocksResponse) Descriptor() ([]byte, []int) { return fileDescriptorBlock, []int{18} }
...
func (*PushBlocks) Descriptor() ([]byte, []int) { return fileDescriptorBlock, []int{19} }
...
var fileDescriptorBlock = []byte{
	...
	,
}
